...
desenhar_quadrado_1_mapa_1_loop_1:
	beq $9 $0 fim_desenhar_quadrado_1_mapa_1_loop_1
	addi $10 $0 16
	
desenhar_quadrado_1_mapa_1_loop_2:
	beq $10 $0 fim_desenhar_quadrado_1_mapa_1_loop_2
	...
	j desenhar_quadrado_1_mapa_1_loop_2
fim_desenhar_quadrado_1_mapa_1_loop_2:
	
	addi $8 $8 -64
	addi $8 $8 128
	addi $9 $9 -1
	
	j desenhar_quadrado_1_mapa_1_loop_1
fim_desenhar_quadrado_1_mapa_1_loop_1:
	lui $8 0x1001
	addi $8 $8 1664
	add $2 $8 $0
	addi $9 $0 3
...
desenhar_quadrado_2_mapa_1_loop_1:
	beq $9 $0 fim_desenhar_quadrado_2_mapa_1_loop_1
	addi $10 $0 32
	
desenhar_quadrado_2_mapa_1_loop_2:
	beq $10 $0 fim_desenhar_quadrado_2_mapa_1_loop_2
	...
	j desenhar_quadrado_2_mapa_1_loop_2
fim_desenhar_quadrado_2_mapa_1_loop_2:
	
	addi $8 $8 -128
	addi $8 $8 128
	addi $9 $9 -1
	
	j desenhar_quadrado_2_mapa_1_loop_1
fim_desenhar_quadrado_2_mapa_1_loop_1:
	addi $29 $29 4                                                    
       	lw $11 0($29)
	addi $29 $29 4                                                    
       	lw $10 0($29)
